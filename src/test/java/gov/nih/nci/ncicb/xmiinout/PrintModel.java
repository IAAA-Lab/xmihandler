package gov.nih.nci.ncicb.xmiinout;
...
public class PrintModel {
  ...
  static boolean noColor = true;

  private static void printInColor(short color, String text) {
    if (noColor)
  ...
  public static void printModel(UMLModel model, boolean setNoColor) {
    noColor = setNoColor;
