...
public class JDomXmiTransformer {
  ...
  private static Logger logger = Logger.getLogger(JDomXmiTransformer.class
          .getName());
  protected Map<String, UMLDatatype> datatypes = new HashMap<>();
  protected List<UMLAttributeBean> attWithMissingDatatypes = new ArrayList<>();
  protected List<UMLOperationParameterBean> paramWithMissingDatatypes = new ArrayList<>();
