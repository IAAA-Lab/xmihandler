...
public class UMLModelBean extends JDomDomainObject implements UMLModel {
  ...
  private List<UMLInterface> interfaces = new ArrayList<>();
  ...
  private List<UMLDependency> dependencies = new ArrayList<>();

  private Map<String, UMLDatatype> datatypes = new HashMap<>();
