...
public class ArgoJDomXmiTransformer extends JDomXmiTransformer {
  ...
  private Map<String, UMLTagDefinitionBean> tagDefinitionsByNameMap = new HashMap<>();
  private Map<String, UMLTagDefinitionBean> tagDefinitionsByXmiIdMap = new HashMap<>();

  private Map<String, UMLStereotypeDefinitionBean> stereotypeDefinitionsByName = new HashMap<>();
  private Map<String, UMLStereotypeDefinitionBean> stereotypeDefinitionsByXmiId = new HashMap<>();


  public void addTagDefinition(UMLTagDefinitionBean tagDefinition) {
    tagDefinitionsByXmiIdMap.put(tagDefinition.getXmiId(),
            tagDefinition);
    tagDefinitionsByNameMap.put(tagDefinition.getName(),
            tagDefinition);
  }
  ...
  UMLTagDefinitionBean toUMLTagDefinition(Element tdElement) {
    ...
    return new UMLTagDefinitionBean(tdElement, tdElement
