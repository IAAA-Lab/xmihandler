...
public abstract class EABaseImpl extends DefaultXmiHandler {
  ...
  protected Map<String, UMLClassBean> idClassMap = new HashMap<>();

  protected Map<String, UMLInterfaceBean> idInterfaceMap = new HashMap<>();

  protected Map<String, UMLPackageBean> idPkgClassifierMap = new HashMap<>();
  ...
  public void doLoad(java.net.URI uri) {
